...
// use neo4j apoc library to import json data into neo4j
(async () => {
    const uri = 'neo4j+s://deb1798b.databases.neo4j.io';
    const user = 'neo4j';
    const password = 'UVPxDcd2RlTwp_V5hxy29Nf3iLXVpD1E4l9OIHojQaY';
    ...
    async function createFriendship(driver, person1Name, person2Name) {
        ...
        try {
            ...
            const writeResult = await session.executeWrite(tx => tx.run(writeQuery, { person1Name, person2Name }));
            // Check the wite results.
